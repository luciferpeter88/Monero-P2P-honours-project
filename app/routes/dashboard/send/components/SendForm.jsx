    ...
    <div className="flex flex-col md:flex-row gap-5 mt-5  text-white">
      ...
      >
        ...
        <div className="mt-8 mb-3">
          ...
          <div
            className="mt-1 bg-primary p-3 py-4 text-muted-foreground rounded-md flex items-center justify-between"
            style={{ backgroundColor: colorType?.primary }}
          >
      ...
      <div
        className="w-full md:w-64 bg-third p-6 rounded-lg shadow-lg min-h-64"
        style={{ backgroundColor: colorType?.tertiary }}
      >
        {/* Tips */}
